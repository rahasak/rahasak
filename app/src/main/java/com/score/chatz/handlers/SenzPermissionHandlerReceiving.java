 ...
 */
public class SenzPermissionHandlerReceiving extends BaseHandler implements IReceivingComHandler {
    private static final String TAG = SenzPermissionHandlerReceiving.class.getName();
    private static SenzPermissionHandlerReceiving instance;
     ...
     * @return
     */
    public static SenzPermissionHandlerReceiving getInstance() {
        if (instance == null) {
            instance = new SenzPermissionHandlerReceiving();
        }
        return instance;
    }
